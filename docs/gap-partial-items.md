...
| 16 | Fetch retry backoff policy | partial | puemos (100ms × 1.15x) | Consider stronger backoff policy. |
| 17 | Segment fetch timeout setting | partial | hls_downloader (30s), live-stream | Verify configurable segment timeout exists; add test. |
