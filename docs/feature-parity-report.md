...
| P1 | Add advanced capture-rule editor | settings, candidate classifier tests | Done for typed rule-engine/settings primitives with validation; visual import/export/reset UX remains a future surface task. |
